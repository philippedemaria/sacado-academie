...
def create_test_ia(request,idp):
    ...
    if request.method == "POST":
        ...
        for eid in eid_for_rs :
            ...
            relationship = Relationship.objects.create(exercise = exercise, parcours=parcours, maxexo=1, situation=2, duration=2, is_paper = exercise.supportfile.is_paper ,  is_calculator = exercise.supportfile.calculator )
            relationship.students.set(parcours.students.all())
...
def ajax_assign_exercise_to_parcours(request):
    ...
    relation    = Relationship.objects.create(parcours = parcours , exercise = exercise , document_id = 0 , type_id = 0 , ranking =  0 , is_publish= 1 , start= None , date_limit= None, is_paper = supportfile.is_paper ,  duration= supportfile.duration, situation= supportfile.situation ) 
