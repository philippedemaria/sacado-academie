...
\renewcommand{\descriptionlabel}{\hspace{\labelsep}$\bigcirc$}
...
\newcommand{\titreFiche}[2]{\centerline{\Ovalbox{\parbox[t]{0.7\textwidth}{
\vspace{-0.5em}\begin{center} \bf \large #1
\end{center}
\vspace{-0.5em}}}}

  \bigskip
\fancyfoot[L]{\includegraphics[height=1em]{/var/www/sacado/static/img/sacadoA1.png}\textcolor{bleusad}{\textsf{\ \raisebox{2pt}{SACADO. {\tt https://sacado.xyz}}}}}
